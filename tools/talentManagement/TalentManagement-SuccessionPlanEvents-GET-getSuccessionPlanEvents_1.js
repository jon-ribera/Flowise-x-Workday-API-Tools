...
const successionPlan = typeof $successionPlan !== 'undefined' ? $successionPlan : null;

const apiPath = '/talentManagement/v2/successionPlanEvents';
const qParts = [];
(function buildQuery(params) {
    ...
    if (successionPlan !== null && successionPlan !== undefined) params.push(`successionPlan=${encodeURIComponent(successionPlan)}`);
})(qParts);
