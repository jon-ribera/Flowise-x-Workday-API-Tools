...
const caseFlag = typeof $caseFlag !== 'undefined' ? $caseFlag : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/helpCase/v4/values/caseFlagsGroup/caseFlags/';
const qParts = [];
(function buildQuery(params) {
    if (caseFlag !== null && caseFlag !== undefined) params.push(`caseFlag=${encodeURIComponent(caseFlag)}`);
