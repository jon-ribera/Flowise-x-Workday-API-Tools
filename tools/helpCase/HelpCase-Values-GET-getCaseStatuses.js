...
const caseStatus = typeof $caseStatus !== 'undefined' ? $caseStatus : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/helpCase/v4/values/caseStatusesGroup/caseStatuses/';
const qParts = [];
(function buildQuery(params) {
    if (caseStatus !== null && caseStatus !== undefined) params.push(`caseStatus=${encodeURIComponent(caseStatus)}`);
