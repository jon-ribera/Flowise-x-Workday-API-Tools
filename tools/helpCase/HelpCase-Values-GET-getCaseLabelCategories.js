...
const caseLabelCategory = typeof $caseLabelCategory !== 'undefined' ? $caseLabelCategory : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/helpCase/v4/values/caseLabelCategoriesGroup/caseLabelCategories/';
const qParts = [];
(function buildQuery(params) {
    if (caseLabelCategory !== null && caseLabelCategory !== undefined) params.push(`caseLabelCategory=${encodeURIComponent(caseLabelCategory)}`);
