...
const serviceTeam = typeof $serviceTeam !== 'undefined' ? $serviceTeam : null;

const apiPath = '/helpCase/v4/values/serviceTeamsGroup/serviceTeams/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (serviceTeam !== null && serviceTeam !== undefined) params.push(`serviceTeam=${encodeURIComponent(serviceTeam)}`);
})(qParts);
