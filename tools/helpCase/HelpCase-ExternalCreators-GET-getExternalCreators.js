...
const email = typeof $email !== 'undefined' ? $email : null;
const hideBlockedCreators = typeof $hideBlockedCreators !== 'undefined' ? $hideBlockedCreators : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/helpCase/v4/externalCreators';
const qParts = [];
(function buildQuery(params) {
    if (email !== null && email !== undefined) params.push(`email=${encodeURIComponent(email)}`);
    if (hideBlockedCreators !== null && hideBlockedCreators !== undefined) params.push(`hideBlockedCreators=${encodeURIComponent(hideBlockedCreators)}`);
