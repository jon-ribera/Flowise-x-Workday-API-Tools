...
const caseType = typeof $caseType !== 'undefined' ? $caseType : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/helpCase/v4/caseSuggestions';
const qParts = [];
(function buildQuery(params) {
    if (caseType !== null && caseType !== undefined) params.push(`caseType=${encodeURIComponent(caseType)}`);
