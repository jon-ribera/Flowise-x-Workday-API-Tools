...
const client_name = typeof $client_name !== 'undefined' ? $client_name : null;

const apiPath = '/oAuthClient/v1/clientDetails';
const qParts = [];
(function buildQuery(params) {
    if (client_name !== null && client_name !== undefined) params.push(`client_name=${encodeURIComponent(client_name)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the OAuthClient domain.",
