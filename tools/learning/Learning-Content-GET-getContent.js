...
const contentType = typeof $contentType !== 'undefined' ? $contentType : null;
const lastUpdated = typeof $lastUpdated !== 'undefined' ? $lastUpdated : null;
const lifecycleStatus = typeof $lifecycleStatus !== 'undefined' ? $lifecycleStatus : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;
const skills = typeof $skills !== 'undefined' ? $skills : null;
const topics = typeof $topics !== 'undefined' ? $topics : null;

const apiPath = '/learning/v1/content';
const qParts = [];
(function buildQuery(params) {
    if (contentType !== null && contentType !== undefined) params.push(`contentType=${encodeURIComponent(contentType)}`);
    if (lastUpdated !== null && lastUpdated !== undefined) params.push(`lastUpdated=${encodeURIComponent(lastUpdated)}`);
    if (lifecycleStatus !== null && lifecycleStatus !== undefined) params.push(`lifecycleStatus=${encodeURIComponent(lifecycleStatus)}`);
    ...
    if (skills !== null && skills !== undefined) params.push(`skills=${encodeURIComponent(skills)}`);
    if (topics !== null && topics !== undefined) params.push(`topics=${encodeURIComponent(topics)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Learning domain.",
