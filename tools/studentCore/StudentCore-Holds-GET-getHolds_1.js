...
const active = typeof $active !== 'undefined' ? $active : null;
const holdReason = typeof $holdReason !== 'undefined' ? $holdReason : null;
...
const apiPath = '/studentCore/v1/holds';
const qParts = [];
(function buildQuery(params) {
    if (active !== null && active !== undefined) params.push(`active=${encodeURIComponent(active)}`);
    if (holdReason !== null && holdReason !== undefined) params.push(`holdReason=${encodeURIComponent(holdReason)}`);
