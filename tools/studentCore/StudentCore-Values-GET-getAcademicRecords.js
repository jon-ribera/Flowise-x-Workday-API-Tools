...
const academicRecord = typeof $academicRecord !== 'undefined' ? $academicRecord : null;
...
const reason = typeof $reason !== 'undefined' ? $reason : null;
const student = typeof $student !== 'undefined' ? $student : null;

const apiPath = '/studentCore/v1/values/holds/academicRecords/';
const qParts = [];
(function buildQuery(params) {
    if (academicRecord !== null && academicRecord !== undefined) params.push(`academicRecord=${encodeURIComponent(academicRecord)}`);
    ...
    if (reason !== null && reason !== undefined) params.push(`reason=${encodeURIComponent(reason)}`);
    if (student !== null && student !== undefined) params.push(`student=${encodeURIComponent(student)}`);
})(qParts);
