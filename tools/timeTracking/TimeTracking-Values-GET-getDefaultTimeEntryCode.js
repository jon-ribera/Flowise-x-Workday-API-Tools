...
const inOutCodeOnly = typeof $inOutCodeOnly !== 'undefined' ? $inOutCodeOnly : null;
...
const apiPath = '/timeTracking/v5/values/timeTypes/defaultTimeEntryCode/';
const qParts = [];
(function buildQuery(params) {
    if (date !== null && date !== undefined) params.push(`date=${encodeURIComponent(date)}`);
    if (inOutCodeOnly !== null && inOutCodeOnly !== undefined) params.push(`inOutCodeOnly=${encodeURIComponent(inOutCodeOnly)}`);
