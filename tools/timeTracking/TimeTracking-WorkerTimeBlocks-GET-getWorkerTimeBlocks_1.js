...
const projectPlanTask = typeof $projectPlanTask !== 'undefined' ? $projectPlanTask : null;
...
const apiPath = '/timeTracking/v5/workerTimeBlocks';
const qParts = [];
(function buildQuery(params) {
    ...
    if (projectPlanTask !== null && projectPlanTask !== undefined) params.push(`projectPlanTask=${encodeURIComponent(projectPlanTask)}`);
