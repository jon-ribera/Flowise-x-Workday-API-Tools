...
const periodDate = typeof $periodDate !== 'undefined' ? $periodDate : null;

const apiPath = `/timeTracking/v5/workers/${ID}/timeTotals`;
const qParts = [];
(function buildQuery(params) {
    ...
    if (periodDate !== null && periodDate !== undefined) params.push(`periodDate=${encodeURIComponent(periodDate)}`);
})(qParts);
