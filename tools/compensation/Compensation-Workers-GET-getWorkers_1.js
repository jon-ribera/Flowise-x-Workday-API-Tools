...
const apiPath = '/compensation/v2/workers';
const qParts = [];
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Compensation domain.",
