...
const programOfStudyType = typeof $programOfStudyType !== 'undefined' ? $programOfStudyType : null;

const apiPath = '/studentRecruiting/v1/values/academicRequirementEvaluation/educationalInstitution/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (programOfStudyType !== null && programOfStudyType !== undefined) params.push(`programOfStudyType=${encodeURIComponent(programOfStudyType)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the StudentRecruiting domain.",
