...
const type = typeof $type !== 'undefined' ? $type : null;

const apiPath = '/api/prismAnalytics/v3/super/dataChanges';
const qParts = [];
(function buildQuery(params) {
    ...
    if (type !== null && type !== undefined) params.push(`type=${encodeURIComponent(type)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the PrismAnalytics domain.",
