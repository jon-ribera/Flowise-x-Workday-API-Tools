...
const fileContainerID = typeof $fileContainerID !== 'undefined' ? $fileContainerID : null;
const requestBody = typeof $requestBody !== 'undefined' ? $requestBody : null;

const apiPath = `/api/prismAnalytics/v3/super/fileContainers/${fileContainerID}/files`;
let bodyData = null;
if (requestBody !== null) {
