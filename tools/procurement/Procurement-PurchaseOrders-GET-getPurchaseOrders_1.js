...
const buyer = typeof $buyer !== 'undefined' ? $buyer : null;
const company = typeof $company !== 'undefined' ? $company : null;
const excludeCanceled = typeof $excludeCanceled !== 'undefined' ? $excludeCanceled : null;
const excludeClosed = typeof $excludeClosed !== 'undefined' ? $excludeClosed : null;
...
const orderFromConnection = typeof $orderFromConnection !== 'undefined' ? $orderFromConnection : null;
...
const apiPath = '/procurement/v5/purchaseOrders';
const qParts = [];
(function buildQuery(params) {
    if (buyer !== null && buyer !== undefined) params.push(`buyer=${encodeURIComponent(buyer)}`);
    if (company !== null && company !== undefined) params.push(`company=${encodeURIComponent(company)}`);
    if (excludeCanceled !== null && excludeCanceled !== undefined) params.push(`excludeCanceled=${encodeURIComponent(excludeCanceled)}`);
    if (excludeClosed !== null && excludeClosed !== undefined) params.push(`excludeClosed=${encodeURIComponent(excludeClosed)}`);
    ...
    if (orderFromConnection !== null && orderFromConnection !== undefined) params.push(`orderFromConnection=${encodeURIComponent(orderFromConnection)}`);
