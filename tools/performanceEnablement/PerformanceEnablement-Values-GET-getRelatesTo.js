...
const relatesToTag = typeof $relatesToTag !== 'undefined' ? $relatesToTag : null;

const apiPath = '/performanceEnablement/v5/values/relatesTo/relatesTo/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (relatesToTag !== null && relatesToTag !== undefined) params.push(`relatesToTag=${encodeURIComponent(relatesToTag)}`);
})(qParts);
