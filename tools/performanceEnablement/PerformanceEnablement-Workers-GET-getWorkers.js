...
const includeTerminatedWorkers = typeof $includeTerminatedWorkers !== 'undefined' ? $includeTerminatedWorkers : null;
...
const apiPath = '/performanceEnablement/v5/workers';
const qParts = [];
(function buildQuery(params) {
    if (includeTerminatedWorkers !== null && includeTerminatedWorkers !== undefined) params.push(`includeTerminatedWorkers=${encodeURIComponent(includeTerminatedWorkers)}`);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the PerformanceEnablement domain.",
