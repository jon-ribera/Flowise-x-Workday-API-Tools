...
const workers = typeof $workers !== 'undefined' ? $workers : null;

const apiPath = '/performanceEnablement/v5/values/workersToNotify/workersToNotify/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (workers !== null && workers !== undefined) params.push(`workers=${encodeURIComponent(workers)}`);
})(qParts);
