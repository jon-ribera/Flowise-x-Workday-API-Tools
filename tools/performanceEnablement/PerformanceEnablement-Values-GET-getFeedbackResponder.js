...
const templateType = typeof $templateType !== 'undefined' ? $templateType : null;
const worker = typeof $worker !== 'undefined' ? $worker : null;

const apiPath = '/performanceEnablement/v5/values/feedbackResponder/feedbackResponder/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (templateType !== null && templateType !== undefined) params.push(`templateType=${encodeURIComponent(templateType)}`);
