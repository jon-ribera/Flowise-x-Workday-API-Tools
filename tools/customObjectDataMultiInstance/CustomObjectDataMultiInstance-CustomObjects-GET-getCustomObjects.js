...
const businessObjectResource = typeof $businessObjectResource !== 'undefined' ? $businessObjectResource : null;
const businessObjectId = typeof $businessObjectId !== 'undefined' ? $businessObjectId : null;
const customObjectAlias = typeof $customObjectAlias !== 'undefined' ? $customObjectAlias : null;

const apiPath = `/customObject/v2/${businessObjectResource}/${businessObjectId}/customObjects/${customObjectAlias}`;
