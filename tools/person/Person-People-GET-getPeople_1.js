...
const universal_ID = typeof $universal_ID !== 'undefined' ? $universal_ID : null;

const apiPath = '/person/v4/people';
const qParts = [];
(function buildQuery(params) {
    ...
    if (universal_ID !== null && universal_ID !== undefined) params.push(`universal_ID=${encodeURIComponent(universal_ID)}`);
})(qParts);
