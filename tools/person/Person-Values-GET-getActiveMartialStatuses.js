...
const countryOrRegion = typeof $countryOrRegion !== 'undefined' ? $countryOrRegion : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/person/v4/values/maritalStatus/activeMartialStatuses/';
const qParts = [];
(function buildQuery(params) {
    if (countryOrRegion !== null && countryOrRegion !== undefined) params.push(`countryOrRegion=${encodeURIComponent(countryOrRegion)}`);
