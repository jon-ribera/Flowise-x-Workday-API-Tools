...
const currentName = typeof $currentName !== 'undefined' ? $currentName : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const nameConfigurationFormat = typeof $nameConfigurationFormat !== 'undefined' ? $nameConfigurationFormat : null;
...
const apiPath = `/person/v4/countries/${ID}/nameComponents`;
const qParts = [];
(function buildQuery(params) {
    if (currentName !== null && currentName !== undefined) params.push(`currentName=${encodeURIComponent(currentName)}`);
    if (limit !== null && limit !== undefined) params.push(`limit=${encodeURIComponent(limit)}`);
    if (nameConfigurationFormat !== null && nameConfigurationFormat !== undefined) params.push(`nameConfigurationFormat=${encodeURIComponent(nameConfigurationFormat)}`);
