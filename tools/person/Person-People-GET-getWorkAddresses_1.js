...
const effective = typeof $effective !== 'undefined' ? $effective : null;
...
const apiPath = `/person/v4/people/${ID}/workAddresses`;
const qParts = [];
(function buildQuery(params) {
    if (effective !== null && effective !== undefined) params.push(`effective=${encodeURIComponent(effective)}`);
