...
const primaryOnly = typeof $primaryOnly !== 'undefined' ? $primaryOnly : null;
const publicOnly = typeof $publicOnly !== 'undefined' ? $publicOnly : null;
const usageType = typeof $usageType !== 'undefined' ? $usageType : null;
const usedFor = typeof $usedFor !== 'undefined' ? $usedFor : null;

const apiPath = `/person/v4/workContactInformationChanges/${ID}/instantMessengers`;
const qParts = [];
(function buildQuery(params) {
    ...
    if (primaryOnly !== null && primaryOnly !== undefined) params.push(`primaryOnly=${encodeURIComponent(primaryOnly)}`);
    if (publicOnly !== null && publicOnly !== undefined) params.push(`publicOnly=${encodeURIComponent(publicOnly)}`);
    if (usageType !== null && usageType !== undefined) params.push(`usageType=${encodeURIComponent(usageType)}`);
    if (usedFor !== null && usedFor !== undefined) params.push(`usedFor=${encodeURIComponent(usedFor)}`);
})(qParts);
