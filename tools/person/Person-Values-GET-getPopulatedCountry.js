...
const person = typeof $person !== 'undefined' ? $person : null;

const apiPath = '/person/v4/values/personalInformationCountry/populatedCountry/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (person !== null && person !== undefined) params.push(`person=${encodeURIComponent(person)}`);
})(qParts);
