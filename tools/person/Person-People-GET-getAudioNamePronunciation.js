...
const currentAudio = typeof $currentAudio !== 'undefined' ? $currentAudio : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = `/person/v4/people/${ID}/audioNamePronunciation`;
const qParts = [];
(function buildQuery(params) {
    if (currentAudio !== null && currentAudio !== undefined) params.push(`currentAudio=${encodeURIComponent(currentAudio)}`);
