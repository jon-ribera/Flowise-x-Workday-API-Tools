...
const audience = typeof $audience !== 'undefined' ? $audience : null;
...
const apiPath = '/helpArticle/v1/articleVersions';
const qParts = [];
(function buildQuery(params) {
    if (audience !== null && audience !== undefined) params.push(`audience=${encodeURIComponent(audience)}`);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the HelpArticle domain.",
