...
const entryType = typeof $entryType !== 'undefined' ? $entryType : null;
const expenseEntryStatus = typeof $expenseEntryStatus !== 'undefined' ? $expenseEntryStatus : null;
...
const apiPath = '/expense/v1/entries';
const qParts = [];
(function buildQuery(params) {
    if (entryType !== null && entryType !== undefined) params.push(`entryType=${encodeURIComponent(entryType)}`);
    if (expenseEntryStatus !== null && expenseEntryStatus !== undefined) params.push(`expenseEntryStatus=${encodeURIComponent(expenseEntryStatus)}`);
