...
const expenseReportMemo = typeof $expenseReportMemo !== 'undefined' ? $expenseReportMemo : null;
const expenseReportStatus = typeof $expenseReportStatus !== 'undefined' ? $expenseReportStatus : null;
...
const apiPath = '/expense/v1/reports';
const qParts = [];
(function buildQuery(params) {
    if (expenseReportMemo !== null && expenseReportMemo !== undefined) params.push(`expenseReportMemo=${encodeURIComponent(expenseReportMemo)}`);
    if (expenseReportStatus !== null && expenseReportStatus !== undefined) params.push(`expenseReportStatus=${encodeURIComponent(expenseReportStatus)}`);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Expense domain.",
