...
const disallowFixedItems = typeof $disallowFixedItems !== 'undefined' ? $disallowFixedItems : null;
...
const apiPath = '/expense/v1/expenseItems';
const qParts = [];
(function buildQuery(params) {
    if (disallowFixedItems !== null && disallowFixedItems !== undefined) params.push(`disallowFixedItems=${encodeURIComponent(disallowFixedItems)}`);
