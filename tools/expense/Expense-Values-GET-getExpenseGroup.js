...
const expenseReportLine = typeof $expenseReportLine !== 'undefined' ? $expenseReportLine : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/expense/v1/values/bespokePrompt/expenseGroup/';
const qParts = [];
(function buildQuery(params) {
    if (expenseReportLine !== null && expenseReportLine !== undefined) params.push(`expenseReportLine=${encodeURIComponent(expenseReportLine)}`);
