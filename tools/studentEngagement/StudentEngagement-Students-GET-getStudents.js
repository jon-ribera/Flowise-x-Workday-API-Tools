...
const activeOnly = typeof $activeOnly !== 'undefined' ? $activeOnly : null;
const programOfStudy = typeof $programOfStudy !== 'undefined' ? $programOfStudy : null;
const search = typeof $search !== 'undefined' ? $search : null;

const apiPath = '/studentEngagement/v1/students';
const qParts = [];
(function buildQuery(params) {
    ...
    if (activeOnly !== null && activeOnly !== undefined) params.push(`activeOnly=${encodeURIComponent(activeOnly)}`);
    if (programOfStudy !== null && programOfStudy !== undefined) params.push(`programOfStudy=${encodeURIComponent(programOfStudy)}`);
    if (search !== null && search !== undefined) params.push(`search=${encodeURIComponent(search)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the StudentEngagement domain.",
