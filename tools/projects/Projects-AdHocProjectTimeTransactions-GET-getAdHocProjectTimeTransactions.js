...
const projectOrProjectHierarchy = typeof $projectOrProjectHierarchy !== 'undefined' ? $projectOrProjectHierarchy : null;

const apiPath = '/projects/v1/adHocProjectTimeTransactions';
const qParts = [];
(function buildQuery(params) {
    ...
    if (projectOrProjectHierarchy !== null && projectOrProjectHierarchy !== undefined) params.push(`projectOrProjectHierarchy=${encodeURIComponent(projectOrProjectHierarchy)}`);
})(qParts);
