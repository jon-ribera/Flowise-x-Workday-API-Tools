...
const projectResourcePlan = typeof $projectResourcePlan !== 'undefined' ? $projectResourcePlan : null;

const apiPath = '/projects/v1/resourcePlanLines';
const qParts = [];
(function buildQuery(params) {
    ...
    if (projectResourcePlan !== null && projectResourcePlan !== undefined) params.push(`projectResourcePlan=${encodeURIComponent(projectResourcePlan)}`);
})(qParts);
