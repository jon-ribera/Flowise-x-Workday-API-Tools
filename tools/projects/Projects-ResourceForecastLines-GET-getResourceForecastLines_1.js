...
const projectResource = typeof $projectResource !== 'undefined' ? $projectResource : null;
const projectRole = typeof $projectRole !== 'undefined' ? $projectRole : null;

const apiPath = '/projects/v1/resourceForecastLines';
const qParts = [];
(function buildQuery(params) {
    ...
    if (projectResource !== null && projectResource !== undefined) params.push(`projectResource=${encodeURIComponent(projectResource)}`);
    if (projectRole !== null && projectRole !== undefined) params.push(`projectRole=${encodeURIComponent(projectRole)}`);
})(qParts);
