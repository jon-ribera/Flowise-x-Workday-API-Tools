...
const planPhase = typeof $planPhase !== 'undefined' ? $planPhase : null;
const project = typeof $project !== 'undefined' ? $project : null;

const apiPath = '/projects/v1/planTasks';
const qParts = [];
(function buildQuery(params) {
    ...
    if (planPhase !== null && planPhase !== undefined) params.push(`planPhase=${encodeURIComponent(planPhase)}`);
