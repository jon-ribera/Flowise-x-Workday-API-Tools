...
const requirementCategory = typeof $requirementCategory !== 'undefined' ? $requirementCategory : null;
const resourcePlanLine = typeof $resourcePlanLine !== 'undefined' ? $resourcePlanLine : null;

const apiPath = '/projects/v1/values/resourcePlan/workerToReplaceUnnamedResources/';
const qParts = [];
(function buildQuery(params) {
    ...
    if (requirementCategory !== null && requirementCategory !== undefined) params.push(`requirementCategory=${encodeURIComponent(requirementCategory)}`);
    if (resourcePlanLine !== null && resourcePlanLine !== undefined) params.push(`resourcePlanLine=${encodeURIComponent(resourcePlanLine)}`);
})(qParts);
