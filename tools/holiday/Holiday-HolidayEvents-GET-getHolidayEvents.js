...
const apiPath = '/holiday/v1/holidayEvents';
const qParts = [];
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Holiday domain.",
