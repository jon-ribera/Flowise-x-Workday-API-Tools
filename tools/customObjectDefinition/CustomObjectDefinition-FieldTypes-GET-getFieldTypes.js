...
const fieldType = typeof $fieldType !== 'undefined' ? $fieldType : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/customObjectDefinition/v1/fieldTypes';
const qParts = [];
(function buildQuery(params) {
    if (fieldType !== null && fieldType !== undefined) params.push(`fieldType=${encodeURIComponent(fieldType)}`);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the CustomObjectDefinition domain.",
