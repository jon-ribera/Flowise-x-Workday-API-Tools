...
const eventTarget = typeof $eventTarget !== 'undefined' ? $eventTarget : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = `/businessProcess/v1/types/${ID}/attachmentCategories`;
const qParts = [];
(function buildQuery(params) {
    if (eventTarget !== null && eventTarget !== undefined) params.push(`eventTarget=${encodeURIComponent(eventTarget)}`);
