...
const eventStep = typeof $eventStep !== 'undefined' ? $eventStep : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/businessProcess/v1/values/sendBack/to/';
const qParts = [];
(function buildQuery(params) {
    if (eventStep !== null && eventStep !== undefined) params.push(`eventStep=${encodeURIComponent(eventStep)}`);
