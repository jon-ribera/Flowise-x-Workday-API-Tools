...
const endDate = typeof $endDate !== 'undefined' ? $endDate : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;
const payComponent = typeof $payComponent !== 'undefined' ? $payComponent : null;
const startDate = typeof $startDate !== 'undefined' ? $startDate : null;
const worker = typeof $worker !== 'undefined' ? $worker : null;

const apiPath = '/payroll/v2/values/payrollInputsGroup/runCategories/';
const qParts = [];
(function buildQuery(params) {
    if (endDate !== null && endDate !== undefined) params.push(`endDate=${encodeURIComponent(endDate)}`);
    ...
    if (payComponent !== null && payComponent !== undefined) params.push(`payComponent=${encodeURIComponent(payComponent)}`);
    if (startDate !== null && startDate !== undefined) params.push(`startDate=${encodeURIComponent(startDate)}`);
