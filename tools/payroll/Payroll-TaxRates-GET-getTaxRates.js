...
const payrollStateAuthorityTaxCode = typeof $payrollStateAuthorityTaxCode !== 'undefined' ? $payrollStateAuthorityTaxCode : null;

const apiPath = '/payroll/v2/taxRates';
const qParts = [];
(function buildQuery(params) {
    ...
    if (payrollStateAuthorityTaxCode !== null && payrollStateAuthorityTaxCode !== undefined) params.push(`payrollStateAuthorityTaxCode=${encodeURIComponent(payrollStateAuthorityTaxCode)}`);
})(qParts);
