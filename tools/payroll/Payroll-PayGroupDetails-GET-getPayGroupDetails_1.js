...
const runCategories = typeof $runCategories !== 'undefined' ? $runCategories : null;

const apiPath = '/payroll/v2/payGroupDetails';
const qParts = [];
(function buildQuery(params) {
    ...
    if (runCategories !== null && runCategories !== undefined) params.push(`runCategories=${encodeURIComponent(runCategories)}`);
})(qParts);
