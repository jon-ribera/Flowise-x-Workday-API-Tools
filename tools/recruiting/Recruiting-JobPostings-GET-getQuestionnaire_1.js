...
const questionnaireType = typeof $questionnaireType !== 'undefined' ? $questionnaireType : null;

const apiPath = `/recruiting/v4/jobPostings/${ID}/questionnaire`;
const qParts = [];
(function buildQuery(params) {
    ...
    if (questionnaireType !== null && questionnaireType !== undefined) params.push(`questionnaireType=${encodeURIComponent(questionnaireType)}`);
})(qParts);
