...
const interviewStatus = typeof $interviewStatus !== 'undefined' ? $interviewStatus : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/recruiting/v4/interviews';
const qParts = [];
(function buildQuery(params) {
    if (interviewStatus !== null && interviewStatus !== undefined) params.push(`interviewStatus=${encodeURIComponent(interviewStatus)}`);
