...
const audienceTypeParm = typeof $audienceTypeParm !== 'undefined' ? $audienceTypeParm : null;
const connectType = typeof $connectType !== 'undefined' ? $connectType : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/connect/v2/values/AudiencePromptGroup/audienceType/';
const qParts = [];
(function buildQuery(params) {
    if (audienceTypeParm !== null && audienceTypeParm !== undefined) params.push(`audienceTypeParm=${encodeURIComponent(audienceTypeParm)}`);
    if (connectType !== null && connectType !== undefined) params.push(`connectType=${encodeURIComponent(connectType)}`);
