...
const event = typeof $event !== 'undefined' ? $event : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;
const organizationType = typeof $organizationType !== 'undefined' ? $organizationType : null;
const worker = typeof $worker !== 'undefined' ? $worker : null;

const apiPath = '/staffing/v7/values/organizationAssignmentChangesGroup/businessUnits/';
const qParts = [];
(function buildQuery(params) {
    if (effectiveDate !== null && effectiveDate !== undefined) params.push(`effectiveDate=${encodeURIComponent(effectiveDate)}`);
    if (event !== null && event !== undefined) params.push(`event=${encodeURIComponent(event)}`);
    ...
    if (organizationType !== null && organizationType !== undefined) params.push(`organizationType=${encodeURIComponent(organizationType)}`);
