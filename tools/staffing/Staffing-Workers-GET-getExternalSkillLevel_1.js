...
const externalSkillId = typeof $externalSkillId !== 'undefined' ? $externalSkillId : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = `/staffing/v7/workers/${ID}/externalSkillLevel`;
const qParts = [];
(function buildQuery(params) {
    if (externalSkillId !== null && externalSkillId !== undefined) params.push(`externalSkillId=${encodeURIComponent(externalSkillId)}`);
