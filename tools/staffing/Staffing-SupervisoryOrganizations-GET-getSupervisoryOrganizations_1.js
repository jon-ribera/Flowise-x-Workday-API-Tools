...
const includeInactive = typeof $includeInactive !== 'undefined' ? $includeInactive : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/staffing/v7/supervisoryOrganizations';
const qParts = [];
(function buildQuery(params) {
    if (includeInactive !== null && includeInactive !== undefined) params.push(`includeInactive=${encodeURIComponent(includeInactive)}`);
