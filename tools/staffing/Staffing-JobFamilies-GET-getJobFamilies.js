...
const jobFamilyGroup = typeof $jobFamilyGroup !== 'undefined' ? $jobFamilyGroup : null;
const jobProfile = typeof $jobProfile !== 'undefined' ? $jobProfile : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;

const apiPath = '/staffing/v7/jobFamilies';
const qParts = [];
(function buildQuery(params) {
    if (inactive !== null && inactive !== undefined) params.push(`inactive=${encodeURIComponent(inactive)}`);
    if (jobFamilyGroup !== null && jobFamilyGroup !== undefined) params.push(`jobFamilyGroup=${encodeURIComponent(jobFamilyGroup)}`);
    if (jobProfile !== null && jobProfile !== undefined) params.push(`jobProfile=${encodeURIComponent(jobProfile)}`);
