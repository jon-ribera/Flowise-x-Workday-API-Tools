...
const skill = typeof $skill !== 'undefined' ? $skill : null;
const skillSource = typeof $skillSource !== 'undefined' ? $skillSource : null;

const apiPath = `/staffing/v7/workers/${ID}/explicitSkills`;
const qParts = [];
(function buildQuery(params) {
    ...
    if (skill !== null && skill !== undefined) params.push(`skill=${encodeURIComponent(skill)}`);
    if (skillSource !== null && skillSource !== undefined) params.push(`skillSource=${encodeURIComponent(skillSource)}`);
})(qParts);
