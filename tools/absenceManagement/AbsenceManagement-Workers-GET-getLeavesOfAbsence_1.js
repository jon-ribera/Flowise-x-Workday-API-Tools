...
const leaveType = typeof $leaveType !== 'undefined' ? $leaveType : null;
...
const apiPath = `/absenceManagement/v4/workers/${ID}/leavesOfAbsence`;
const qParts = [];
(function buildQuery(params) {
    if (fromDate !== null && fromDate !== undefined) params.push(`fromDate=${encodeURIComponent(fromDate)}`);
    if (leaveType !== null && leaveType !== undefined) params.push(`leaveType=${encodeURIComponent(leaveType)}`);
