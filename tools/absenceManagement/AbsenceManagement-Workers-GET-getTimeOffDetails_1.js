...
const timeOffType = typeof $timeOffType !== 'undefined' ? $timeOffType : null;
const toDate = typeof $toDate !== 'undefined' ? $toDate : null;

const apiPath = `/absenceManagement/v4/workers/${ID}/timeOffDetails`;
const qParts = [];
(function buildQuery(params) {
    ...
    if (timeOffType !== null && timeOffType !== undefined) params.push(`timeOffType=${encodeURIComponent(timeOffType)}`);
