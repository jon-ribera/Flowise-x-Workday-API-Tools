...
const includeTest = typeof $includeTest !== 'undefined' ? $includeTest : null;

const apiPath = '/graph/v1/versions';
const qParts = [];
(function buildQuery(params) {
    if (includeTest !== null && includeTest !== undefined) params.push(`includeTest=${encodeURIComponent(includeTest)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Graph domain.",
