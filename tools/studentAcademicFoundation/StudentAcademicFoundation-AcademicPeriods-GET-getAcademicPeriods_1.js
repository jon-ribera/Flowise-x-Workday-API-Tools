...
const academicCalendar = typeof $academicCalendar !== 'undefined' ? $academicCalendar : null;
const academicYear = typeof $academicYear !== 'undefined' ? $academicYear : null;
...
const apiPath = '/studentAcademicFoundation/v1/academicPeriods';
const qParts = [];
(function buildQuery(params) {
    if (academicCalendar !== null && academicCalendar !== undefined) params.push(`academicCalendar=${encodeURIComponent(academicCalendar)}`);
    if (academicYear !== null && academicYear !== undefined) params.push(`academicYear=${encodeURIComponent(academicYear)}`);
