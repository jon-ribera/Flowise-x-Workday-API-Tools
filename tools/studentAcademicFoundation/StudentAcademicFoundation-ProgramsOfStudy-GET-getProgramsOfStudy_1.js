...
const academicUnit = typeof $academicUnit !== 'undefined' ? $academicUnit : null;
const cipCode = typeof $cipCode !== 'undefined' ? $cipCode : null;
const educationalCredentials = typeof $educationalCredentials !== 'undefined' ? $educationalCredentials : null;
...
const programType = typeof $programType !== 'undefined' ? $programType : null;

const apiPath = '/studentAcademicFoundation/v1/programsOfStudy';
const qParts = [];
(function buildQuery(params) {
    if (academicLevel !== null && academicLevel !== undefined) params.push(`academicLevel=${encodeURIComponent(academicLevel)}`);
    if (academicUnit !== null && academicUnit !== undefined) params.push(`academicUnit=${encodeURIComponent(academicUnit)}`);
    if (cipCode !== null && cipCode !== undefined) params.push(`cipCode=${encodeURIComponent(cipCode)}`);
    if (educationalCredentials !== null && educationalCredentials !== undefined) params.push(`educationalCredentials=${encodeURIComponent(educationalCredentials)}`);
    ...
    if (programType !== null && programType !== undefined) params.push(`programType=${encodeURIComponent(programType)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the StudentAcademicFoundation domain.",
