...
const inactive = typeof $inactive !== 'undefined' ? $inactive : null;
const institution = typeof $institution !== 'undefined' ? $institution : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;
const superior = typeof $superior !== 'undefined' ? $superior : null;

const apiPath = '/studentAcademicFoundation/v1/academicUnits';
const qParts = [];
(function buildQuery(params) {
    if (effectiveDate !== null && effectiveDate !== undefined) params.push(`effectiveDate=${encodeURIComponent(effectiveDate)}`);
    if (inactive !== null && inactive !== undefined) params.push(`inactive=${encodeURIComponent(inactive)}`);
    if (institution !== null && institution !== undefined) params.push(`institution=${encodeURIComponent(institution)}`);
    ...
    if (superior !== null && superior !== undefined) params.push(`superior=${encodeURIComponent(superior)}`);
})(qParts);
