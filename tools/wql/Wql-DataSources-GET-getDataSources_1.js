...
const alias = typeof $alias !== 'undefined' ? $alias : null;
const dataSourceIndexType = typeof $dataSourceIndexType !== 'undefined' ? $dataSourceIndexType : null;
const limit = typeof $limit !== 'undefined' ? $limit : null;
const offset = typeof $offset !== 'undefined' ? $offset : null;
const searchString = typeof $searchString !== 'undefined' ? $searchString : null;

const apiPath = '/wql/v1/dataSources';
const qParts = [];
(function buildQuery(params) {
    if (alias !== null && alias !== undefined) params.push(`alias=${encodeURIComponent(alias)}`);
    if (dataSourceIndexType !== null && dataSourceIndexType !== undefined) params.push(`dataSourceIndexType=${encodeURIComponent(dataSourceIndexType)}`);
    ...
    if (searchString !== null && searchString !== undefined) params.push(`searchString=${encodeURIComponent(searchString)}`);
})(qParts);
...
const ERROR_MAP = {
    ...
    403: "Forbidden — The Integration System User (ISU) lacks required domain security policies. Verify the Security Group has permissions on the Wql domain.",
